...
### Workflow
1. **MANDATORY - READ ENTIRE FILE**: Read [`ooxml.md`](ooxml.md) (~900 lines) completely from start to finish. **NEVER set any range limits when reading this file.** Read the full file content for the Document library API, OMML equation patterns, and XML patterns for directly editing document files.
...
3. **Read documentation and unpack**:
   - **MANDATORY - READ ENTIRE FILE**: Read [`ooxml.md`](ooxml.md) (~900 lines) completely from start to finish. **NEVER set any range limits when reading this file.** Pay special attention to the "Document Library", "Mathematical Equations (OMML)", and "Tracked Change Patterns" sections.
